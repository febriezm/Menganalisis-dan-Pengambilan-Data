            ...
            <div class="col-md-6 col-lg-7 d-flex">
              ...
              <a class="btn font-weight-bold" href="dashboard.php" role="button">〱</a>
                  ...
                  <div class="align-items-center mb-3 pb-2">
                    <h1 class="fw-bold mb-0 font-weight-bold text-center">Data Barang
                                    ...
                                    <div class="jumbotron">
                                        ...
                                        <form action="proses_input.php" method="POST">
                                            <div class="form-group">
                                                ...
                                                <label for="barang"></label>
                                                <input type="text" placeholder="Nama Barang" class="form-control" name="nama_brg"/>
                                                <label for="barang"></label>
                                                <input type="text" placeholder="Kategori" class="form-control" name="kategori"/>
                                                <label for="barang"></label>
                                                <input type="text" placeholder="Link Image" class="form-control" name="image"/>
                                                <label for="barang"></label>
            ...
            <thead class="thead-dark">
                ...
                <?php foreach ($data as $room): ?>
                    <tr class="bg-dark text-light text-muted">
                        ...
                        <td>
                            <?php echo "<a href='edit.php?kode=$room[ID]'>🖍</a>" ?>
                        </td>
                        <td>
                            <?php echo "<a href='delete.php?kode=$room[ID]'>❌</a>" ?>
                        </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
