    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col col-xl-10">
        ...
        <div class="card mb-2 shadow-lg">
          ...
          <a role="button" href="databarang_user.php" class="btn btn-lg btn-block btn-secondary font-weight-light">Data Barang</a>
        </div>
        <div class="card mb-2 shadow-lg">
          <div class="card-body">
          <img class="img-fluid" src="peminjaman.png" width="70" height="70">
          </div>
          <a role="button" href="peminjaman_user.php" class="btn btn-lg btn-block btn-secondary font-weight-light">Peminjaman</a>
        </div>
      </div>
      <div class="card-deck mb-2 text-center">
        <div class="card mb-2 shadow-lg">
          ...
          <a role="button" href="peminjam_user.php" class="btn btn-lg btn-block btn-secondary font-weight-light">Peminjam</a>
        </div>
        <div class="card mb-2 shadow-lg">
          <div class="card-body">
